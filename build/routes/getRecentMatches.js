...
exports.router.get("/startingMatchData/:steamID32", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { steamID32 } = req.params;
    // const recentMatches = await axios.get(`${openDotaApi}/players/${steamID32}`);
    const recentMatches = yield axios_1.default.get(
...
exports.router.get("/getMatches/:steamID32/:startDateTime", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
